...
public class CatalogController {
    ...
    public ResponseEntity<Map<String, String>> addCatalog(
        ...
        if (bindingResult.hasErrors()) {
            ...
            Catalog catalog = catalogMapper.createCatalogFormModelToCatalog(catalogFormModel);
    
            // Konversi categoryId ke objek Category
            Category category = categoryService.getCategoryById(catalogFormModel.getCategoryId());
            ...
            // Save the catalog entit   y
            catalogService.addCatalog(catalog);
    
            // Set the success message
            String successMessage = "Product '" + catalogFormModel.getProductName() + "' created successfully.";
    ...
    public ResponseEntity<String> updateCatalog(
        ...
        if (file != null && !file.isEmpty()) {
            ...
            Optional<Catalog> existingCatalogOptional = catalogService.findCatalogById(id);
            if (existingCatalogOptional.isPresent()) {
                Catalog existingCatalog = existingCatalogOptional.get();
